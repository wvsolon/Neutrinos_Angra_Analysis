...
while (ind < len(list_PDT)):
    list_OFF1 = [list_PDT[ind]]
    print('DATE LIST: ',list_PDT[ind])
    ...
    save_PD (h_PDP_OFF1, h_PDD_OFF1, h_PDT_OFF1, hg_Sig_OFF1, 'PD_m10_Date_'+list_PDT[ind])
