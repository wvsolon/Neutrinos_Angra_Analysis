...
i_mult = int(sys.argv[1])

s_arq_PD_ON = 'PD_ON_30_m' + sys.argv[1]
s_arq_PD_OFF = 'PD_OFF_30_m' + sys.argv[1]
...
save_PD (h_PDP_ON, h_PDD_ON, h_PDT_ON, hg_Sig_ON, s_arq_PD_ON)
save_PD (h_PDP_OFF, h_PDD_OFF, h_PDT_OFF, hg_Sig_OFF, s_arq_PD_OFF)
