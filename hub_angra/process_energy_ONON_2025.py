...
list_ON2  = [
            '20250116','20250117','20250118','20250119','20250120','20250121',
...
totalPositrons_ON1, totalNonSat_ON1, h_Sig_ON1 = fnt_process_list_PD(list_ON1, h_PDP_ON1, h_PDD_ON1, h_PDT_ON1, bins_interval)
...
totalPositrons_ON2, totalNonSat_ON2, h_Sig_ON2 = fnt_process_list_PD(list_ON2, h_PDP_ON2, h_PDD_ON2, h_PDT_ON2, bins_interval)
...
hg_Sig_ON1 = [((x*i_day)**0.5) for x in h_Sig_ON1]     ## x é a quantidade do bin / quantidade de dias 
hg_Sig_ON2 = [((x*i_day)**0.5) for x in h_Sig_ON2] 

save_PD (h_PDP_ON1, h_PDD_ON1, h_PDT_ON1, hg_Sig_ON1, 'PD_ON1_15_m10')
save_PD (h_PDP_ON2, h_PDD_ON2, h_PDT_ON2, hg_Sig_ON2, 'PD_ON2_15_m10')
