...
# para 15 dias  OFF deslocado


list_OFF5  = [
            '20241123','20241124','20241125',
            '20241126','20241127','20241128','20241129','20241130','20241201',
            '20241202','20241203','20241204','20241205','20241206','20241207'
           ]

list_OFF6  = [
            '20241120','20241121','20241122',
            '20241123','20241124','20241125',
            '20241126','20241127','20241128','20241129','20241130','20241201',
            '20241202','20241203','20241204'
           ]

list_OFF7  = [
            '20241117','20241118','20241119',
            '20241120','20241121','20241122',
            '20241123','20241124','20241125',
            '20241126','20241127','20241128','20241129','20241130','20241201'
           ]
...
totalPositrons_OFF1, totalNonSat_OFF1, h_Sig_OFF1 = fnt_process_list_PD(list_OFF5, h_PDP_OFF1, h_PDD_OFF1, h_PDT_OFF1, bins_interval)

print(len(h_PDP_OFF1))
print(len(h_PDD_OFF1))
print(len(h_PDT_OFF1))
print('Em ',len(list_OFF5),' dias: ',totalPositrons_OFF1)
print('Por dia: ',totalPositrons_OFF1/len(list_OFF5))
print('Em Hz: ',totalPositrons_OFF1/len(list_OFF5)/86400) 
print('Em ',len(list_OFF5),' dias (NS): ',totalNonSat_OFF1)
print('Por dia (NS): ',totalNonSat_OFF1/len(list_OFF5))
print('Em Hz (NS): ',totalNonSat_OFF1/len(list_OFF5)/86400) 
...
totalPositrons_OFF2, totalNonSat_OFF2, h_Sig_OFF2 = fnt_process_list_PD(list_OFF6, h_PDP_OFF2, h_PDD_OFF2, h_PDT_OFF2, bins_interval)

print(len(h_PDP_OFF2))
print(len(h_PDD_OFF2))
print(len(h_PDT_OFF2))
print('Em ',len(list_OFF6),' dias: ',totalPositrons_OFF2)
print('Por dia: ',totalPositrons_OFF2/len(list_OFF6))
print('Em Hz: ',totalPositrons_OFF2/len(list_OFF6)/86400) 
print('Em ',len(list_OFF6),' dias (NS): ',totalNonSat_OFF2)
print('Por dia (NS): ',totalNonSat_OFF2/len(list_OFF6))
print('Em Hz (NS): ',totalNonSat_OFF2/len(list_OFF6)/86400) 
...
totalPositrons_OFF3, totalNonSat_OFF3, h_Sig_OFF3 = fnt_process_list_PD(list_OFF7, h_PDP_OFF3, h_PDD_OFF3, h_PDT_OFF3, bins_interval)

print(len(h_PDP_OFF3))
print(len(h_PDD_OFF3))
print(len(h_PDT_OFF3))
print('Em ',len(list_OFF7),' dias: ',totalPositrons_OFF3)
print('Por dia: ',totalPositrons_OFF3/len(list_OFF7))
print('Em Hz: ',totalPositrons_OFF3/len(list_OFF7)/86400) 
print('Em ',len(list_OFF7),' dias (NS): ',totalNonSat_OFF3)
print('Por dia (NS): ',totalNonSat_OFF3/len(list_OFF7))
print('Em Hz (NS): ',totalNonSat_OFF3/len(list_OFF7)/86400) 
...
totalPositrons_OFF4, totalNonSat_OFF4, h_Sig_OFF4 = fnt_process_list_PD(list_OFF8, h_PDP_OFF4, h_PDD_OFF4, h_PDT_OFF4, bins_interval)

print(len(h_PDP_OFF4))
print(len(h_PDD_OFF4))
print(len(h_PDT_OFF4))
print('Em ',len(list_OFF8),' dias: ',totalPositrons_OFF4)
print('Por dia: ',totalPositrons_OFF4/len(list_OFF8))
print('Em Hz: ',totalPositrons_OFF4/len(list_OFF8)/86400) 
print('Em ',len(list_OFF8),' dias (NS): ',totalNonSat_OFF4)
print('Por dia (NS): ',totalNonSat_OFF4/len(list_OFF8))
print('Em Hz (NS): ',totalNonSat_OFF4/len(list_OFF8)/86400) 
...
hg_Sig_OFF3 = [((x*i_day)**0.5) for x in h_Sig_OFF3] 
hg_Sig_OFF4 = [((x*i_day)**0.5) for x in h_Sig_OFF4] 

save_PD (h_PDP_OFF1, h_PDD_OFF1, h_PDT_OFF1, hg_Sig_OFF1, 'PD_OFF5_15_m10_shift')
save_PD (h_PDP_OFF2, h_PDD_OFF2, h_PDT_OFF2, hg_Sig_OFF2, 'PD_OFF6_15_m10_shift')
save_PD (h_PDP_OFF3, h_PDD_OFF3, h_PDT_OFF3, hg_Sig_OFF3, 'PD_OFF7_15_m10_shift')
save_PD (h_PDP_OFF4, h_PDD_OFF4, h_PDT_OFF4, hg_Sig_OFF4, 'PD_OFF8_15_m10_shift')
